...
#"percent"
#
fathersDF <- read.table("Doc/fathers.txt");
dataGather <- gather(fathersDF, key = EDUCATION, value = PERCENT, -AGE);
fourColors <- c("lightblue", "skyblue3", "rosybrown1","rosybrown3");
FathersToHorizontalBar(dataGather, fourColors,
					   "Father's Age at First Child, by Education",
					   "percent");
#
#
...
fathersDF <- read.table("Doc/fathers.txt");
dataGather <- gather(fathersDF, key = EDUCATION, value = PERCENT, -AGE);
FathersToVerticalBar(dataGather, fourColors,
					   "Father's Age at First Child, by Education",
					   "percent");
#
#"Per capita\nbudget expanditures\nin constant dollars"
...
TwoVectorBaseLinePlot(x, y, "Per capita\nbudget expanditures\nin constant dollars", "5%");
#
#
#
x <- 1967:1977;
y <- c(0.5, 1.8, 4.6, 5.3, 5.3, 5.7, 5.4, 5, 5.5, 6, 5);
TwoVectorLatticeLinePlot(x, y, "Per capita\nbudget expanditures\nin constant dollars", "5%");
#
#
#
x <- 1967:1977;
y <- c(0.5, 1.8, 4.6, 5.3, 5.3, 5.7, 5.4, 5, 5.5, 6, 5);
TwoVectorGgplot2LinePlot(x, y, "Per capita\nbudget expanditures\nin constant dollars", "5%");
#
#"Car weight (lb/1000)"
#"Miles per gallon of fuel"
RangeFrameBasePlot(mtcars$wt, mtcars$mpg, "Car weight (lb/1000)", "Miles per gallon of fuel");
#
#"Car weight (lb/1000)"
#"Miles per gallon of fuel"
RangeFrameLatticePlot(mtcars$wt, mtcars$mpg, "Car weight (lb/1000)", "Miles per gallon of fuel");
#
#"Car weight (lb/1000)"
#"Miles per gallon of fuel"
RangeFrameGgplot2Plot(mtcars, "Car weight (lb/1000)", "Miles per gallon of fuel");
#
#"Car weight (lb/1000)"
#"Miles per gallon of fuel"
LatticeDotDash(mtcars$wt, "Car weight (lb/1000)", mtcars$mpg, "Miles per gallon of fuel");
#
#
#
Ggplot2DotDash(mtcars, "Car weight (lb/1000)", "Miles per gallon of fuel");
#
#
#"Number of stations reporting Richter \nMagnitude of Fiji earthquakes (n=1000)"
BaseQuakesBoxplot(quakes, "Number of stations reporting Richter \nMagnitude of Fiji earthquakes (n=1000)");
#
#
#"Number of stations reporting Richter \nMagnitude of Fiji earthquakes (n=1000)"
LatticeQuakesBoxplot(quakes, "Number of stations reporting Richter \nMagnitude of Fiji earthquakes (n=1000)");
#
#
#"Number of stations reporting Richter \nMagnitude of Fiji earthquakes (n=1000)"
Ggplot2QuakesBoxplot(quakes, "Number of stations reporting Richter \nMagnitude of Fiji earthquakes (n=1000)");
#
#
#"Average scores\non negative emotion traits\nfrom 3896 participants\n(Watson et al., 1988)"
d <- colMeans(msq[, c(2, 7, 34, 36, 42, 43, 46, 55, 68)], na.rm = T) * 10;
BaseBarchart(d, "Average scores on negative\nemotion traits from 3896 participants\n(Watson et al., 1988)");
